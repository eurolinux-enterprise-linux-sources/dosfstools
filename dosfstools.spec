...
Patch2: dosfstools-3.0.20-allow-lowercase-labels.patch
...
%patch2 -p1 -b .allow-lowercase-labels
...
%changelog
* Fri Apr 27 2018 Jaroslav Škarvada <jskarvad@redhat.com> - 3.0.20-10
- Backported fix to allow lowercase labels
  Resolves: rhbz#1553860
